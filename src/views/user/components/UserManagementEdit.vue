<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="家长名单" prop="parent_id" v-if="form.type == 1">
        <el-select v-model="form.parent_id" placeholder="请选择" :disabled="title == '编辑'">
           <el-option
      ...
      <el-form-item label="备注" prop="description">
        ...
        <el-input type="textarea" :rows="2" v-model.trim="form.description" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="学校" prop="school">
        <el-input v-model.trim="form.school" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="密码" prop="password" v-if="form.type == 4">
        <el-input
      ...
      return {
        ...
        rules: {
          ...
          parent_id: [
            { required: true, trigger: 'change', validator: (rule, value, callback) => {
                if (value === '' &&  this.form.type == "1") {
                  callback(new Error('请选择一个家长，若无对应家长，请先为其添加'));
                } else {
                  callback();
                }
            } },
          ...
          phone: [
            ...
            { pattern: /^1(3\d|4[5-9]|5[0-35-9]|6[567]|7[0-8]|8\d|9[0-35-9])\d{8}$/, message: '请输入正确的联系电话' },
          ],
          type: [
      ...
      save() {
        this.$refs['form'].validate(async (valid) => {
          if (valid) {
            ...
            const result = await request({
              url: "https://mastercenter.cn/user/" + apiName,
              method: "post",
              data: {
                ...this.form
              }
